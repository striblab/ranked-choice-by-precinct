...
Analysis of ranked-choice races by precinct


## Data

* Precincts: https://gisdata.mn.gov/dataset/bdry-votingdistricts
* Results: ftp://ftp.sos.state.mn.us/20171107/
...
```html
<div data-pym-src="http://static.startribune.com/projects/ranked-choice-by-precinct">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/ranked-choice-by-precinct/",
      "url": "http://static.startribune.com/news/projects-staging/all/ranked-choice-by-precinct/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/ranked-choice-by-precinct/",
      "url": "http://static.startribune.com/news/projects/all/ranked-choice-by-precinct/"
    }
  }
}
```
